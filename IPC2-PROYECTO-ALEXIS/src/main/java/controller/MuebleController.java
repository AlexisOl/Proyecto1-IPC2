...
public class MuebleController extends HttpServlet {
    ...
    String list = "administracion/mueble/list.jsp";
    String add = "administracion/mueble/add.jsp";
    String edit = "administracion/mueble/edit.jsp";
    String view = "administracion/mueble/view.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MuebleController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MuebleController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
