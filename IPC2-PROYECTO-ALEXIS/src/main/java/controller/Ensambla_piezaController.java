...
public class Ensambla_piezaController extends HttpServlet {

    String list = "fabrica/ensambla_pieza/list.jsp";
    String add = "fabrica/ensambla_pieza/add.jsp";
    String edit = "fabrica/ensambla_pieza/edit.jsp";
    String view = "fabrica/ensambla_pieza/view.jsp";
    String login = "index.jsp";

    Ensambla_pieza object;
    Ensambla_piezaDao dao = new Ensambla_piezaDao();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Ensambla_piezaController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Ensambla_piezaController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isLogged()) {
            try {
                ...
                switch (action) {
                    case "Registrar":
                        object = new Ensambla_pieza();
                        object.setMueble(muebleDao.search(Integer.parseInt(request.getParameter("mueble_id"))));
                        object.setPieza(piezaDao.search(Integer.parseInt(request.getParameter("pieza_id"))));
