...
<html>
    <head>
        ...
        <title>Reporte Mueble menos vendido</title>
    </head>
    <body>
        ...
        <div class="container body">
            ...
            <form action="ReporteController" method="GET">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3">
                        <input type="submit" name="accion" value="Filtrar mueble_" class="btn btn-danger" />
                    </div>
                    <div class="col-md-3 text-right">
                        <a href="ReporteController?accion=export_min_venta_mueble&inicio=<%=inicio%>&fin=<%=fin%>" class="btn btn-warning"><i class="fa fa-save" aria-hidden="true"></i> Exportar</a>
                    </div>
                </div>
            </form>
            ...
            <br>
            <%
                Mueble mueble = new MuebleDao().getMenosVendido(inicio, fin);
                if (mueble == null) {
            %>
            <div class="form-row">
            ...
            <%} else {%>
            <div class="form-row">
                <h3>Mueble menos vendido [ <%=mueble.getNombre()%> ]</h3>
            </div>
            <br>
