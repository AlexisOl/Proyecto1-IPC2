        ...
        <div class="container body">
            ...
            <form action="ReporteController" method="GET">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3">
                        <input type="submit" name="accion" value="Filtrar ventas" class="btn btn-danger" />
                    </div>
                    <div class="col-md-3 text-right">
                        <a href="ReporteController?accion=export_venta&inicio=<%=inicio%>&fin=<%=fin%>" class="btn btn-warning"><i class="fa fa-save" aria-hidden="true"></i> Exportar</a>
                    </div>
                </div>
            </form>
            ...
            <table class="table">
                ...
                <%
                    Iterator<Detalle_factura> iterator = new Detalle_facturaDao().listByFecha(inicio, fin).iterator();
